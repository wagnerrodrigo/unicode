                ...
                <table class='table table-striped' id="table1">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>Fornecedor 1</td>
                            <td>92.419.334/0001-12</td>
                            <td>fornecedor@empresa.com.br</td>
                            <td>(99) 9 9999-9999</td>
                            <td>
                                <form method="GET" action="/fornecedores" data-bs-toggle="modal" data-bs-target="#xlarge-view" class="btn btn-primary" style="padding: 8px 12px;">
                                    @csrf
