...
@section('title', 'Lista conciliações')
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel16">Novo Movimento</h4>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="bi bi-x" data-feather="x"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{route('movimentos')}}" method="POST" style="padding: 10px;">
                        @csrf
                ...
                <div class="modal-footer">
                    <div class="col-sm-12 d-flex justify-content-end">
                        ...
                        <a href="{{route('movimentos')}}" class="btn btn-secondary me-1 mb-1">Cancelar</a>
                    </div>
                    </form>
