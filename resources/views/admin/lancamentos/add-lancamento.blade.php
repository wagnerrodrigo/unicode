                    ...
                    <div class="d-flex">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input required class="form-control input-add teste" name="tipo_pagamento" id="condicao_pagamento" readonly style="cursor: pointer; width: 200px" />
                        ...
                        <div class="modal-body">
                            <div class="d-flex flex-column" style="width: 100%">
                                <div class="px-5 mb-3">
                                    ...
                                    <input class="form-control input-busca" name="titular_conta" type="text" id="titular_conta" readonly style="width: 60rem" placeholder="{{ $lancamento->fk_tab_tipo_despesa_id == 1
                    ...
                    <form name="form_conta_pix">
                        ...
                        <div class="modal-body">
                            <div class="d-flex flex-column" style="width: 100%">
                                <div class="px-5 mb-3">
                                    <strong>TITULAR</strong>
                                    <input class="form-control input-busca" name="titular_conta_pix" type="text" id="titular_conta_pix" readonly style="width: 60rem" placeholder="{{ $lancamento->fk_tab_tipo_despesa_id == 1
                                                      ? $lancamento->nome_empregado
                                                      : $lancamento->de_razao_social }}" />
