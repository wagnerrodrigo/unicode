  ...
  <div id="main" style="margin-top: 5px;">
    <div class="main-content container-fluid">
      ...
      <tr>
            ...
            <td><a href="{{route('showCotacao',$pedido->id_solicitacao_compra)}}" class="btn btn-primary"><i class="bi bi-envelope-open"></i></a></td>
            <!-- <td><a href="{{route('showDiretoria',$pedido->id_solicitacao_compra)}}" class="btn btn-primary"><i class="bi bi-envelope-open"></i></a></td> -->
