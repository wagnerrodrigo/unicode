            ...
            <div class="card">
                ...
                <form class="col-md-12">
                    ...
                    <div class="col-md-3" style="display: inline-block">
                        <input class="form-control me-2" type="search" placeholder="Buscar por Solicitante"
                            aria-label="Search">
                    </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        @foreach ($pedidos as $pedido)
                            <tr>
                                ...
                                <td>
                                    @if ($pedido->status_atual == 'Análise da Diretoria da Área')
                                        <!-- *Status Atual* -->
                                        <font color="blue">{{ $pedido->status_atual }}</font>
                                </td>
                            @elseif($pedido->status_atual == 'Em Cotação')
                                <font color="green">{{ $pedido->status_atual }}</font>
                                </td>
                            ...
                            @elseif($pedido->status_atual == 'Reprovado')
                                <font color="red">{{ $pedido->status_atual }}</font>
                                </td>
                        ...
                        @if ($pedido->status_atual == 'Análise da Diretoria da Área')
                            <td>
                                <a href="#staticBackdrop-{{ $pedido->id_solicitacao_compra }}" class="btn btn-primary"
                                    data-bs-toggle="modal"
                                    style="padding-left: 15px ; padding-right:15px ; margin-right: 5px; "
                                    data-bs-target="#staticBackdrop-{{ $pedido->id_solicitacao_compra }}"><i
                                        class="bi bi-eye-fill"></i></a>
                                <a href="#staticBackdrop1-{{ $pedido->id_solicitacao_compra }}" class="btn btn-primary"
                                    data-bs-toggle="modal"
                                    style="padding-left: 15px ; padding-right:15px ; margin-right: 5px;"
                                    data-bs-target="#staticBackdrop1-{{ $pedido->id_solicitacao_compra }}"><i
                                        class="bi bi-file-earmark-text"></i></a>
                                <a href="{{ route('showDiretoria', $pedido->id_solicitacao_compra) }}"
                                    style="padding-left: 15px ; padding-right:15px ; margin-right: 5px; "
                                    class="btn btn-primary"><i class="bi bi-check-circle"></i></a>
                                <a href="" class="btn btn-primary"
                                    style="padding-left: 15px ; padding-right:15px ; "><i class="bi bi-trash"></i></a>
                            </td>
                        @elseif($pedido->status_atual == 'Em Cotação')
                            <td>
                                <a href="#staticBackdrop-{{ $pedido->id_solicitacao_compra }}" class="btn btn-primary"
                                    data-bs-toggle="modal"
                                    data-bs-target="#staticBackdrop-{{ $pedido->id_solicitacao_compra }}"
                                    style="padding-left: 15px ; padding-right:15px ; margin-right: 5px;"><i
                                        class="bi bi-eye-fill"></i></a>
                                <a href="#staticBackdrop1-{{ $pedido->id_solicitacao_compra }}" class="btn btn-primary"
                                    data-bs-toggle="modal"
                                    data-bs-target="#staticBackdrop1-{{ $pedido->id_solicitacao_compra }}"
                                    style="padding-left: 15px ; padding-right:15px ; margin-right: 5px;"><i
                                        class="bi bi-file-earmark-text"></i></a>
                                <a href="{{ route('showCotacao', $pedido->id_solicitacao_compra) }}"
                    ...
                    <!-- Detalhes -->
                    <div class="modal fade" id="staticBackdrop-{{ $pedido->id_solicitacao_compra }}"
                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="staticBackdropLabel">Detalhes da Solicitacao:
                                        {{ $pedido->id_solicitacao_compra }}</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">Categoria do Produto: {{ $pedido->de_tipo_produto }}
                                            </div>
                                            ...
                                            <br><br>
                                            <hr><br>
                                            <div class="col-sm-6">Complemento: {{ $pedido->complemento_solicitacao }}
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <!-- Historico -->
                    <div class="modal fade" id="staticBackdrop1-{{ $pedido->id_solicitacao_compra }}"
                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    Descrição: {{ $pedido->complemento_solicitacao }} <br>
                                    <hr>
